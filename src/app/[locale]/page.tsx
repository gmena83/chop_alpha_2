        ...
        <section className="relative min-h-[480px] overflow-hidden">
          ...
          <div className="max-w-[1400px] mx-auto px-4 md:px-8 relative py-12 md:py-16">
            <div className="max-w-lg">
              ...
              <Button
                variant="outline"
                className="text-[#1A5276] px-6 py-3 rounded-md text-sm font-medium bg-transparent border-2 border-[#1A5276] hover:bg-[#1A5276] hover:text-white transition-colors"
              ...
              <div className="flex justify-center gap-3 mt-8">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentTestimonial ? 'bg-white scale-125' : 'bg-white/40 hover:bg-white/60'
                      }`}
